...
public class CreateProductWithDynamoDBPrimingHandler implements 
RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent>, Resource {
	...
	public CreateProductWithDynamoDBPrimingHandler() {
	...
	public void beforeCheckpoint(org.crac.Context<? extends Resource> context) throws Exception {
		productDao.putProduct(new Product("0", "Print 9x13", BigDecimal.valueOf(5)));
    }
