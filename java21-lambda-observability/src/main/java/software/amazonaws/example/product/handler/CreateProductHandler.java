...
public class CreateProductHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    @FlushMetrics(namespace = "ProductAPIWithPowerTools", service = "product", captureColdStart = true)
	public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent requestEvent, Context context) {
		try {
            ...
            metrics.addMetadata("correlation_id", requestEvent.getRequestContext().getRequestId());
